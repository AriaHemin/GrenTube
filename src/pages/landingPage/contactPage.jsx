...
function ContactPage () {
  return (
    <div>
      <LandingPageHeader page={'contact'}/>
      <div className='flex items-center justify-center' >
        <div className='w-1/2 mt-24 py-4 px-2 h-96 bg-[#B1CC33] text-white rounded-xl flex items-center justify-center flex-row' >
          <div className='w-1/2 mx-1'>
            <img className='w-full' src='https://firebasestorage.googleapis.com/v0/b/grentube-66fd4.appspot.com/o/1F34F.svg?alt=media&token=7b2c966e-88aa-4d81-8390-ca592a6c2c96'/>
          </div>
          <div className='w-1/2 mx-1'>
